        ...
        <div class="ContentMenu">
            <header class="HeaderMenu">
                <div class="HeaderMenuDiv">
                    ...
                    <div class="MenuBtnsDiv">
                        <a href="ContactGegevens.php"><button class="MenuBtns">Contact gegevens</button></a>
                    </div>
                    <div class="MenuBtnsDiv">
                        <a href="Partijen.php"><button class="MenuBtns">Partijen</button></a>
                    </div>
                    <div class="MenuBtnsDiv">
                        <a href="Standpunten.php"><button class="MenuBtns">Standpunten</button></a>
                    </div>
                    <div class="MenuBtnsDiv">
                        <a href="Thema.php"><button class="MenuBtns">Thema</button></a>
                    </div>
                </div>
            </header>
        </div>
